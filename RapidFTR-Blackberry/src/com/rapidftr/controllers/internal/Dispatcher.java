...
public class Dispatcher {
	...
	private final ViewChildPhotoGalleryController viewChildPhotoGalleryController;
	private final ViewSelectedPhotoController viewSelectedPhotoController;

	public Dispatcher(ControllerFactory controllerFactory) {
		this.homeScreenController = controllerFactory
				.homeScreenControllerWith(this);
		this.manageChildController = controllerFactory
				.manageChildControllerWith(this);
		this.viewChildrenController = controllerFactory
				.viewChildrenControllerWith(this);
		this.childPhotoController = controllerFactory
				.viewChildPhotoControllerWith(this);
		this.childHistoryController = controllerFactory
				.childHistoryControllerWith(this);
		this.searchChildController = controllerFactory
				.searchChildControllerWith(this);
		...
		this.contactScreenController = controllerFactory
				.contactScreenControllerWith(this);
		this.flagChildController = controllerFactory
				.flagChildControllerWith(this);
		this.viewChildPhotoGalleryController = controllerFactory
				.viewChildPhotoGallery(this);
		this.viewSelectedPhotoController = controllerFactory
				.viewSelectedPhoto(this);
	}
	...
	public void viewChildPhotoGallery(Child child) {
		viewChildPhotoGalleryController.viewChildPhotoGallery(child);
	}

	public void viewSelectedPhoto(String imageLocation) {
		viewSelectedPhotoController.viewSelectedPhoto(imageLocation);
	}
